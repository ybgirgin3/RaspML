...
CVPY_TYPE(dnn_superres_DnnSuperResImpl, dnn_superres_DnnSuperResImpl, Ptr<cv::dnn_superres::DnnSuperResImpl>, Ptr, NoBase, 0);
...
CVPY_TYPE(freetype_FreeType2, freetype_FreeType2, Ptr<cv::freetype::FreeType2>, Ptr, Algorithm, 0);
...
CVPY_TYPE(text_ERFilter, text_ERFilter, Ptr<cv::text::ERFilter>, Ptr, Algorithm, 0);
CVPY_TYPE(text_ERFilter_Callback, text_ERFilter_Callback, Ptr<cv::text::ERFilter::Callback>, Ptr, NoBase, 0);
CVPY_TYPE(text_BaseOCR, text_BaseOCR, Ptr<cv::text::BaseOCR>, Ptr, NoBase, 0);
CVPY_TYPE(text_OCRTesseract, text_OCRTesseract, Ptr<cv::text::OCRTesseract>, Ptr, text_BaseOCR, 0);
CVPY_TYPE(text_OCRHMMDecoder, text_OCRHMMDecoder, Ptr<cv::text::OCRHMMDecoder>, Ptr, text_BaseOCR, 0);
CVPY_TYPE(text_OCRHMMDecoder_ClassifierCallback, text_OCRHMMDecoder_ClassifierCallback, Ptr<cv::text::OCRHMMDecoder::ClassifierCallback>, Ptr, NoBase, 0);
CVPY_TYPE(text_OCRBeamSearchDecoder, text_OCRBeamSearchDecoder, Ptr<cv::text::OCRBeamSearchDecoder>, Ptr, text_BaseOCR, 0);
CVPY_TYPE(text_OCRBeamSearchDecoder_ClassifierCallback, text_OCRBeamSearchDecoder_ClassifierCallback, Ptr<cv::text::OCRBeamSearchDecoder::ClassifierCallback>, Ptr, NoBase, 0);
CVPY_TYPE(text_TextDetector, text_TextDetector, Ptr<cv::text::TextDetector>, Ptr, NoBase, 0);
CVPY_TYPE(text_TextDetectorCNN, text_TextDetectorCNN, Ptr<cv::text::TextDetectorCNN>, Ptr, text_TextDetector, 0);
...
CVPY_TYPE(wechat_qrcode_WeChatQRCode, wechat_qrcode_WeChatQRCode, Ptr<cv::wechat_qrcode::WeChatQRCode>, Ptr, NoBase, pyopencv_cv_wechat_qrcode_wechat_qrcode_WeChatQRCode_WeChatQRCode);
CVPY_TYPE(barcode_BarcodeDetector, barcode_BarcodeDetector, Ptr<cv::barcode::BarcodeDetector>, Ptr, NoBase, pyopencv_cv_barcode_barcode_BarcodeDetector_BarcodeDetector);
...
CVPY_TYPE(ccm_ColorCorrectionModel, ccm_ColorCorrectionModel, Ptr<cv::ccm::ColorCorrectionModel>, Ptr, NoBase, pyopencv_cv_ccm_ccm_ColorCorrectionModel_ColorCorrectionModel);
CVPY_TYPE(mcc_DetectorParameters, mcc_DetectorParameters, Ptr<cv::mcc::DetectorParameters>, Ptr, NoBase, 0);
CVPY_TYPE(mcc_CCheckerDetector, mcc_CCheckerDetector, Ptr<cv::mcc::CCheckerDetector>, Ptr, Algorithm, 0);
CVPY_TYPE(mcc_CChecker, mcc_CChecker, Ptr<cv::mcc::CChecker>, Ptr, NoBase, 0);
CVPY_TYPE(mcc_CCheckerDraw, mcc_CCheckerDraw, Ptr<cv::mcc::CCheckerDraw>, Ptr, NoBase, 0);
...
CVPY_TYPE(rapid_GOSTracker, rapid_GOSTracker, Ptr<cv::rapid::GOSTracker>, Ptr, rapid_Tracker, 0);
CVPY_TYPE(colored_kinfu_Params, colored_kinfu_Params, Ptr<cv::colored_kinfu::Params>, Ptr, NoBase, pyopencv_cv_colored_kinfu_colored_kinfu_Params_Params);
CVPY_TYPE(colored_kinfu_ColoredKinFu, colored_kinfu_ColoredKinFu, Ptr<cv::colored_kinfu::ColoredKinFu>, Ptr, NoBase, 0);
