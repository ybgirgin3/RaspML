...
if __name__ == '__main__':
    ...
    NIRband_num = 3  # Order of NIR band in input raster
    ...
    outputRaster_path =  'output_raster.tif'      # Direcotry of output
    ...
    # resim alacağı yere video ekle
    from take_photo import take

    ds = gdal.Open(take(), GA_ReadOnly)
